...
const statusConfig: Record<BookingStatus, { label: string; className: string }> = {
  ...
  in_progress: { label: 'En route', className: 'bg-indigo-100 text-indigo-800 border border-indigo-200' },
  ...
  cancellation_requested: { label: 'Annulation demandée', className: 'bg-amber-100 text-amber-800 border border-amber-200' },
}
