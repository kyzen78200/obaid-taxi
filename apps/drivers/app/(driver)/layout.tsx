...
export default function DriverLayout({ children }: { children: ReactNode }) {
  ...
  const navLinks = [
    { href: '/',          label: 'Mes courses', icon: <Car className="w-5 h-5" />,      exact: true },
    { href: '/search',    label: 'Chercher',    icon: <Search className="w-5 h-5" />,   exact: false },
    { href: '/calendar',  label: 'Agenda',      icon: <Calendar className="w-5 h-5" />, exact: false },
    { href: '/settings',  label: 'Paramètres',  icon: <Settings className="w-5 h-5" />, exact: false },
  ]
